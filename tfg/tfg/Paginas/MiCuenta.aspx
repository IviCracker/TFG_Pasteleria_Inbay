<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MiCuenta.aspx.cs" Inherits="tfg.Paginas.MiCuenta" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="parentMiCuenta">
            <a href="DatosCuenta.aspx" class="div1MiCuenta">
                <i class="fa-solid fa-user"></i>
                <span>Mis Datos Personales</span>
            </a>
            <a href="DatosTarjeta.aspx" class="div2MiCuenta">
                <i class="fa-solid fa-credit-card"></i>
                <span>Datos de la Tarjeta</span>
            </a>
            <a href="ListaDeseos.aspx" class="div3MiCuenta">
                <i class="fa-solid fa-heart"></i>
                <span>Mi Lista de Deseos</span>
            </a>
            <a href="DetallesPedidos.aspx" class="div4MiCuenta">
