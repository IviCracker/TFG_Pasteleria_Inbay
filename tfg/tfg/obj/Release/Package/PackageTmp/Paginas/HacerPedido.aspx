<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HacerPedido.aspx.cs" Inherits="tfg.Paginas.HacerPedido" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Button ID="button1" OnClick="AgregarAListaDeseos_Click" runat="server" Text="Button1" CommandArgument="Donuts" />
            <asp:Button ID="button2" OnClick="AgregarAListaDeseos_Click" runat="server" Text="Button2" CommandArgument="Buñuelos" />
